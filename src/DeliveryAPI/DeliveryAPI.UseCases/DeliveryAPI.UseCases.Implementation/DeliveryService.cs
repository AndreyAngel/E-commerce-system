...
namespace DeliveryAPI.UseCases.Implementation;
...
public class DeliveryService : IDeliveryService
{
    ...
    public IEnumerable<Delivery> GetByFilter(DeliveryFilterDTORequest filters)
    {
        ...
        {
            deliveries = deliveries.Where(x => x.Status.Equals(filters.Status));
        }
    ...
    public void PickUpOrderFromWarehouse(Guid Id, Guid courierId)
    {
        ...
        if (delivery.Status.Equals(DeliveryStatus.TheOrderReceivedByCustomer))
        {
    ...
    public async void Complete(Guid Id)
    {
        ...
        if (delivery.Status.Equals(DeliveryStatus.WaitingForTheCourier))
        {
            throw new DeliveryStatusException("Order is still waiting for the courier");
        }

        if (delivery.Status.Equals(DeliveryStatus.Canceled))
        {
            throw new DeliveryStatusException("Delivery has already canceled");
        }

        if (delivery.Status.Equals(DeliveryStatus.ReturnedToWarehouse))
        {
